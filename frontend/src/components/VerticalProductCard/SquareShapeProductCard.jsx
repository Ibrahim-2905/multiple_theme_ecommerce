...
//   return (
//     <Card 
//       className="relative overflow-hidden w-full h-64 sm:h-80 md:h-96 group cursor-pointer"
//     >
...
//       >
//         {title && (
//           <Card.Title className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4">
//             {title}
//           </Card.Title>
//         )}
